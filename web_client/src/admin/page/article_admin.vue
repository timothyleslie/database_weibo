            ...
            <el-table :data="data" border style="width: 90%" ref="multipleTable" >
                ...
                <el-table-column>
                    <template slot-scope="scope" width="100px">
                        <el-button type="text" @click="del_weibo(scope.row)" >删除</el-button>
                    </template>
                </el-table-column>
            </el-table><el-button type="primary" @click="addfavorite()" align="center">添加新文章</el-button>
        </div>
        <el-dialog
            width="30%"
            title="修改"
            ...
            <div>
                <el-form :model="form" :rules="rules" ref="form" label-width="150px">
                    <el-form-item label="内容" prop="content">
                        <el-input v-model="form.wname" placeholder="请输入内容"></el-input>
                    </el-form-item>
...
export default {
    ...
    methods:{
        ...
        del_weibo(row){ //删除收藏记录
            this.$confirm('请确认是否要删除该微博记录！', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                this.$http.post(main.url+"/article/del",
                    {'id': row.id,},
                    {
                        headers: {'Content-Type':'application/x-www-form-urlencoded'},
                        emulateJSON: true
